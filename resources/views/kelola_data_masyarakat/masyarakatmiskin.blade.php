        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-4 d-flex justify-content-center">
                <div class="row d-block">
                    <a href="/data/input-masyarakatmiskin" class="text-black focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center text-decoration-none" style="background-color: #b7efff;">Tambah Data</a>
