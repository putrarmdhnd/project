...
<div class="layoutWelcome bg-white py-4 px-9 mb-5 rounded-lg">
    <div class="row d-flex align-items-center">
        <div class="col-12">
            ...
            <p class="textDashboard text-base text-[13px] lg:text-lg font-normal text-secondary">Semua data masyarakat yang menerima PKH Desa Palasari Kecamatan Cipanas</p>
        </div>
