...
<section id="BeritaPengumuman" class="pt-3 ">
    ...
    <article class="space-subHeader container">
        <div data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" class="row">
            <div class="col-md-12 text-end pb-3 "><a href="" class="text-black MoreBeritaPengumuman">Lihat Selengkapnya <svg xmlns="http://www.w3.org/2000/svg" style="width: 1.25rem;" viewBox="0 0 32 32">
