    ...
    <div style="margin-top: 50px;">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="fs-1"> : {{ $surat->status_pernikahan }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="fs-1"> : {{ $surat->tempat_tinggal }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="35%" class="fs-1">Bin/Binti</td>
                <td class="fs-1"> : {{ $surat->bin_perempuan }}</td>
            </tr>
            <tr>
                <td width="35%" class="fs-1">NIK</td>
            ...
            <tr>
                <td width="35%" class="fs-1">Agama</td>
                <td class="fs-1"> : {{ $surat->agama_perempuan }}</td>
            </tr>
            <tr>
                <td width="35%" class="fs-1">Status Pernikahan</td>
                <td class="fs-1"> : {{ $surat->status_pernikahan_perempuan }}</td>
            </tr>
            <tr>
                <td width="35%" class="fs-1">Pekerjaan</td>
            ...
            <tr>
                <td width="35%" class="fs-1">Tempat Tinggal</td>
                <td class="fs-1"> : {{ $surat->tempat_tinggal_perempuan }}</td>
            </tr>
        </table>
