    ...
    [&>div>textarea]:text-secondary [&>div>textarea]:rounded-lg [&>div>textarea]:text-sm [&>div>textarea]:block [&>div>textarea]:w-full [&>div>textarea]:border [&>div>textarea]:shadow-sm ">
            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                        <select
                            class="appearance-none px-3 py-2 @error('kewarganegaraan_anak') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1"
                            id="grid-state" name="kewarganegaraan_anak">
                            <option value="">Pilih Kewarganegaraan</option>
                            <option value="WNI">WNI</option>
                            <option value="WNA">WNA</option>
                        </select>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                        <select
                            class="appearance-none px-3 py-2 @error('agama_anak') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1"
                            id="grid-state" name="agama_anak">
                            <option value="">Pilih Agama</option>
                            <option value="Islam">Islam</option>
                            <option value="Kristen Protestan">Kristen Protestan</option>
                            <option value="Kristen Katolik">Kristen Katolik</option>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                        <select
                            class="appearance-none px-3 py-2 @error('status_perkawinan_anak') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1"
                            id="grid-state" name="status_perkawinan_anak">
                            <option value="">Pilih Status Perkawinan</option>
                            <option value="Belum Kawin">Belum Kawin</option>
                            <option value="Kawin Belum Tercatat">Kawin Belum Tercatat</option>
                            <option value="Kawin Tercatat">Kawin Tercatat</option>
