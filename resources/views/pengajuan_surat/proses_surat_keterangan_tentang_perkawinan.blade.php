            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="warganegara_laki"
                        ...
                        placeholder="Warga Negara" value="{{ old('warganegara_laki', $surat->warganegara_laki) }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="warganegara_perempuan"
                        ...
                        placeholder="Warga Negara" value="{{ old('warganegara_perempuan', $surat->warganegara_perempuan) }}" />
