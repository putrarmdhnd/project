            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                ">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <input type="text" name="ttl"
                            ...
                            placeholder="nama_barang : Cipanas, 20 Agustus 2000" value="{{ old('ttl') }}" />
                        @error('ttl')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="tgl_hilang"
                        ...
                        placeholder="Hari/Tgl. Kehilangan" value="{{ old('tgl_hilang') }}" />
                    @error('tgl_hilang')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="waktu_hilang"
                        ...
                        placeholder="Waktu Kehilangan" value="{{ old('waktu_hilang') }}" />
                    @error('waktu_hilang')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="lokasi_hilang"
                        ...
                        placeholder="lokasi Kehilangan" value="{{ old('lokasi_hilang') }}" />
                    @error('lokasi_hilang')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
